                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      },icon:  Icon(Icons.delete_outline_rounded, color: AppColors.vermelhoDark,size: 24),)
                    ],)
                ],
              ),
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Texto(texto: widget.servicoVO.tempoDuracao ?? "Não informado", tamanhoTexto: 14, peso: FontWeight.normal, cor: AppColors.preto)
                    ],
                  ),Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    spacing: 1,
                    children: [
                      ...
                      Texto(texto: "RS ${widget.servicoVO.valor?.round().toString()}", tamanhoTexto: 14, peso: FontWeight.normal, cor: AppColors.preto)
                    ],
                  )
                ],
              )
